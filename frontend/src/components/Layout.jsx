        ...
        <nav className="flex-1 p-4 space-y-2">
          ...
          {user?.role === 'parent' && (
            <>
              ...
              <Link to="/parent/find-counselor" className={`flex items-center px-4 py-3 rounded-lg transition-colors ${isActive('/parent/find-counselor') ? 'bg-emerald-600 text-white' : 'text-slate-400 hover:bg-slate-800 hover:text-white'}`}>
                <UserPlus className="w-5 h-5 mr-3" />
                Find Counselor
              </Link>
            </>
